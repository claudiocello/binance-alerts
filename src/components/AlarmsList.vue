    ...
    <div class="flex-list">
      <div class="flex-header">
        <div class="push-right">
          <span class="icon-alarm text-faded"></span>
        </div>
      ...
      <div v-for="a in alarmsList" :key="a.id" class="flex-item">
        ...
        <div class="flex-1 push-right">
          <button
            ...
            @click="$bus.emit('setRoute', '/symbol/' + a.symbol)"
          >
            {{ a.pair }}
          </button>
        </div>
        ...
        <div class="flex-1 push-right">
          <span :class="{ 'text-success': a.active, 'text-info': !a.active }">{{
  ...
  methods: {
    ...
    saveAlarm(e) {
      ...
      let price = e.target.percent.value
        ? parseFloat((e.target.price.value * e.target.percent.value) / 100) +
          parseFloat(e.target.price.value)
        : parseFloat(e.target.price.value) || 0;
